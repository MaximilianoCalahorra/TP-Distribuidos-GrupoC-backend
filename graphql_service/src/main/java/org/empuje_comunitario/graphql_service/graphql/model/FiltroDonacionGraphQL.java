...
public class FiltroDonacionGraphQL {
    ...
    ///Constructor:
    public FiltroDonacionGraphQL(Long idFiltroDonacion, Categoria categoria, String nombreFiltro, String fechaHoraAltaDesde, String fechaHoraAltaHasta, EstadoEliminado eliminado) {
